...
namespace Mijora\Venipak\Model\Helper;

use Mijora\Venipak\Model\Helper\MjvpVenipak;
...
class MjvpApi {
    ...
    public function getManifestNumber($id) {
        return $this->cVenipak->buildManifestNumber($this->apiId, $id);
    }
    ...
    public function getLabelPdf($label_numbers) {
        $username = $this->username;
        $password = $this->password;
